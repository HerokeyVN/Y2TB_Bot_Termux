...
//pkg update -y && pkg install wget curl proot tar -y && wget https://raw.githubusercontent.com/AndronixApp/AndronixOrigin/master/Installer/Ubuntu20/ubuntu20.sh -O ubuntu20.sh && chmod +x ubuntu20.sh && bash ubuntu20.sh
	...
	echo $cyan.$line3.$green;
	@system("echo \"dpkg --configure -a && apt-get update\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	echo $cyan.$line3.$green;
	@system("echo \"echo y|apt install git\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	echo $cyan.$line3.$green;
	@system("echo \"echo y|apt install wget\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	echo $cyan.$line3.$green;
	@system("echo \"echo y|apt install curl\"|bash ./start-ubuntu20.sh");
	@system("echo \"echo y|apt install curl build-essential\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	echo $cyan.$line3.$green;
	@system("echo \"curl -sL https://deb.nodesource.com/setup_18.x | bash && echo y|apt install -y nodejs\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	print_delay($yellow."143mb".$lang["use_mem"]."\n", 250);
	echo $cyan.$line3.$green;
	@system("echo \"echo y|apt install gcc g++ make zip\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
	...
	echo $cyan.$line3.$green;
	@system("echo \"echo y|apt install build-essential libcairo2-dev libpango1.0-dev libjpeg-dev libgif-dev librsvg2-dev\"|bash ./start-ubuntu20.sh");
	echo ("\n");
	print_delay($yellow.$lang["done"], 500);
	sleep(1);
	clear();
