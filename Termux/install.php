...
//clearLine();
clear();
print_delay($lang["thanks2"], 600);
sleep(2);
clear();
print_delay($lang["noti_check_sys"], 600);
sleep(1);
echo "\n";
echo $cyan . $line2;
...
sleep(1);
$t = getRam();
if ((($t[0] / 1024) / 1024) / 1024 >= $minRam)
	echo $white . "\r -Ram: " . $tcl . $lang["good"];
else {
	$check = false;
	$tcl = $light_red;
...
sleep(1);
$t = getMem();
if (($t[2] / 1000) / 1000 >= $minMem)
	echo $white . "\r -Memory: " . $tcl . $lang["good"];
else {
	$check = false;
	$tcl = $light_red;
