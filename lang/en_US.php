...
$lang = array(
	...
	"m_info" => "https://vangbanlanhat.github.io/VangBanLaNhat-Page/",
	...
	"nodejs_install" => "Install NodeJS 22.x(LTS) on Ubuntu...",
    ...
    "add_fbstate" => "Add/Change fbstate.json",
    "paste_fbstate" => "Please paste the fbstate code here and ",
    "sure_fbstate" => "Are you sure you want to add the above FBstate code to the bot? (y/n) (default: y)",
    "illegal_fbstate" => "Invalid FBstate snippet! Please try again later!",
